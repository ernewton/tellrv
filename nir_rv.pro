...
PRO NIR_RV, order, data, hdr, $
	...
	showplot=showplot, chi=chi, corr_range=corr_range, maxshift=maxshift
...
; 		multiplot
	...
	ERN_RV, data_tc_new, std_tc_new, wrange=wrange, pixscale=pixscale, rv0=rv0, showplot=showplot, chi=chi, corr_range=corr_range
